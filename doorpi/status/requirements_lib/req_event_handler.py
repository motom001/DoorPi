...
''',
    ...
    libraries=dict(
        ...
        sqlite3=dict(
            ...
            text_configuration='',
            configuration=[
                dict(section='DoorPi', key='eventlog', type='string', default='!BASEPATH!/conf/eventlog.db',
                     mandatory=False, description='Ablageort der SQLLite Datenbank für den Event-Handler.')
            ],
            text_links={
