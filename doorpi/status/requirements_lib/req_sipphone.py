...
REQUIREMENT = dict(
    ...
    configuration=[
        ...
        dict(section=SIPPHONE_SECTION, key='dialtone', type='string', default='', mandatory=False, description='Pfad zur DialTone Datei. diese wird abgespielt, wenn eine Klingel betätigt wird und dient als Zeichen, dass es klingelt für den Besucher. (z.B. /usr/share/doorpi/dialtone.wav)'),
