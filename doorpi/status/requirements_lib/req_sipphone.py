...
Für den Betrieb hinter einem NAT-Router steht das STUN-Protokoll zur Verfügung.''',
            ...
            configuration=[
                ...
                dict(section=SIPPHONE_SECTION, key='video', type='boolean', default='False', mandatory=False, description='Soll ein Video-Stream über das SIP-Phone mit gesendet werden? Dies blockt ggf. das entsprechende Gerät!'),
                dict(section=SIPPHONE_SECTION, key='video_device', type='string', default='', mandatory=False, description='Kamera, die für die Aufnahme genutzt wird - wenn nichts angegeben wird, dann wird die erste verfügbare genutzt. Bitte dazu in der LOG-Datei nach "possible videodevices:" suchen'),
                dict(section=SIPPHONE_SECTION, key='video_size', type='string', default='VGA', mandatory=False, description='möglich Werte: 1020P, 720P, CIF, HVGA, QCIF, QVGA oder VGA.'),
