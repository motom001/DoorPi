...
from plugins.interfaces.hardware.docs import DOCUMENTATION as HARDWARE_INTERFACE_BASE_CLASS_DOCUMENTATION
...
DOCUMENTATION = copy.deepcopy(INTERFACEBASECLASS_DOCUMENTATION).update(dict(
